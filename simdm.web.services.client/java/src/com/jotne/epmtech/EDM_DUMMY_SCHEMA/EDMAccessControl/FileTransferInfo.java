...
package com.jotne.epmtech.EDM_DUMMY_SCHEMA.EDMAccessControl;

public class FileTransferInfo  extends com.jotne.epmtech.EDM_DUMMY_SCHEMA.EDMAccessControl.EDMbaseEntity  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://epmtech.jotne.com/EDM_DUMMY_SCHEMA/EDMAccessControl", "fileTransferInfo"));
